...
final class HydratorBasicTypesTest extends TestCase
{
    ...
    {
        assertEquals($data, (new Hydrator())->hydrate($data, $type));
    }
    ...
    {
        assertInstanceOf(Error::class, (new Hydrator())->hydrate($data, $type));
    }
}
